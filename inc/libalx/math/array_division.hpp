 ...
 ******************************************************************************/
static inline
void	alx_array_division_ldbl	(ssize_t n,
					long double dest[restrict],
					const long double src1[restrict],
					const long double src2[restrict])
{
...
static inline
void	alx_array_division	(ssize_t n,
					double dest[restrict],
					const double src1[restrict],
					const double src2[restrict])
{
...
static inline
void	alx_array_division_flt	(ssize_t n,
					float dest[restrict],
					const float src1[restrict],
					const float src2[restrict])
{
 ...
 ******* include guard ********************************************************
 ******************************************************************************/
#endif		/* libalx/math/array_division.hpp */
